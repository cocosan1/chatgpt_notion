...
def get_nearlynode():
    ...
    if submitted:
        ...
        QA_PROMPT_TMPL = \
            ...
            --------------------\
            ###参考: 飛騨の家具についての情報###\
            ・特徴は100年の歴史からくる飛騨の匠の志、技術、伝統を継承している。\
            ・森の恵みである木を大切にしている。節のある木、枝、葉まで使う。植林も行っている。\
            ・日本の山を元気にするため、日本の杉を始めとした国産材の活用などを通して日本の山にお金を\
                還元している。\
            ・腰にやさしい椅子の研究を外科医と共に行ってきた。その技術を生かしたSEOTO-EXという椅子がヒット。\
            ・良い素材を使うことで木の質感が強く感じられる仕上げにこだわっている。\
            ・技術により木の椅子でも座り心地が柔らかい。\
            ・長く愛着を持って付き合っていける家具。\
            ----------------------\
            \
            あなたは絆を重視する優秀なマーケターです。\
            飛騨の木の家具を販売するための戦略、戦術を立案しようとしています。\
            \
            以下の質問に対し日本語で答えます。前回と同じ回答の場合は同じ回答を行います。\
            \
            ###質問###\
            1. 上記のコンテキスト情報をもとに\
                {theme}に関する情報を抽出して、テーマ毎にまとめてください。具体な内容にしてください。\
            2. この情報を基に飛騨の木の家具の販売につながる接客術と展示方法を詳細な具体例を交えて教えてください。'
